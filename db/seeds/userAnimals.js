export function seedUserAnimals(db) {
  const rows = [
    ...
    ["Woodpecke", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Blue Jay", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Bobcat", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Cottontail", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Deer", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Great Horn", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Mourning D", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Red-tailed", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Turkey", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Weasel", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Wild Turk", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Woodland", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Coyote", "assets/images/userCreation/badge_icon_armadillo.png"],
    ["Eastern", "assets/images/userCreation/badge_icon_armadillo.png"],
  ];
