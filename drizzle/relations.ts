...
import { answerChoices, riddleAnswerChoices, riddles, userColors, users, userAnimals } from "./schema";

export const riddleAnswerChoicesRelations = relations(riddleAnswerChoices, ({one}) => ({
